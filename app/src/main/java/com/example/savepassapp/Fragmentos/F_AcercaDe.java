...
public class F_AcercaDe extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Ir_Instagram.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ir_p_instagram = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.github.com"));
        ...
        Ir_Youtube.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ir_p_youtube = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.twitter.com"));
        ...
        Ir_Twitter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ir_p_twitter = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.WhatsApp.com"));
        ...
        Ir_terminos_politicas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ir_p_terminos_politicas = new Intent(Intent.ACTION_VIEW, Uri.parse("https://sites.google.com/view/terminosypoliticassavepass"));
